...
namespace Reflect {
    ...
    (function (exporter) {
        ...
        const HashMap = {
            ...
            get: downLevel
                ? <V>(map: HashMap<V>, key: string | number ): V | undefined => hasOwn.call(map, key) ? map[key] : undefined
                : <V>(map: HashMap<V>, key: string | number ): V | undefined => map[key],
        };
         ...
         *
         */
        function decorate(decorators: (ClassDecorator | PropertyDecorator | MethodDecorator)[], target: any, propertyKey?: string | symbol, attributes?: PropertyDescriptor | null): PropertyDescriptor | Function | undefined {
